...
int realmain(int argc, char *argv[])
{
	...
	if (!pie_LoadShaders(war_getShadowFilterSize(), war_getPointLightPerPixelLighting() && getTerrainShaderQuality() == TerrainShaderQuality::NORMAL_MAPPING, war_getVolumetricLighting()))
	{
		return EXIT_FAILURE;
	}
	if (!screenInitialise())
